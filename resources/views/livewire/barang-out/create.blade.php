            ...
            <div>
                <form wire:submit.prevent="store">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" wire:model="tanggal_keluar" class="form-control @error('tanggal_keluar') is-invalid @enderror" id="tanggal_keluar" placeholder="Pilih Tanggal">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model="status" class="form-control @error('status') is-invalid @enderror" aria-label="Default select example">
